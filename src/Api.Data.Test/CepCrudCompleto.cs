...
namespace Api.Data.Test
{
    ...
    {
        private ServiceProvider _servideProvide;
        public CepCrudCompleto(DbTeste dbTeste)
        {
            _servideProvide = dbTeste.ServiceProvider;
        }
        ...
        {
             using (var context = _servideProvide.GetService<MyContext>())
             {
                ...
                Assert.NotNull(_registroSelecionado);
                Assert.Equal(_registroAtualizado.Cep,_registroSelecionado.Cep);
                Assert.Equal(_registroSelecionado.Logradouro, _registroSelecionado.Logradouro);
                Assert.Equal(_registroSelecionado.Numero,_registroSelecionado.Numero);
                Assert.Equal(_registroSelecionado.MunicipioId,_registroSelecionado.MunicipioId);
